...
public class AnimalMain {
    ...
    public static void main(String[] args) {
        Cat kat = new Cat("Joep", "Mijn huis", "Whiskas", "male", "De britse korthaar","outside");
        Dog hond = new Dog("Fluffy", "Huize Fluf", "male", "Pedigree", "Duitse Herder");
        Lion leeuw = new Lion("Simba", "Artis", "female", 7, "Africa");
        Tiger tiger = new Tiger("Hello", "Diergaarde Blijdorp", "male", 5, "Africa");
        Wolf wolf = new Wolf("Moon", "Drenthe", "female", 3, "North America");

        System.out.println(kat.sleepHours() + " hours");
        System.out.println(leeuw.feedDate());
        System.out.println(wolf.animalMovement());
        System.out.println(tiger.feedDate());
